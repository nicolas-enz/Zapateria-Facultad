...
{
    public partial class AdministradorBuscarCategorias : System.Web.UI.Page
    {
        ...
        {
            string where = "", sql = "SELECT * FROM Categorias";
            ...
            if (txtNombreCat.Text != "" && ddNombreCat.SelectedValue != "")
            {
                where = ArmarSentencia(txtNombreCat.Text, ddNombreCat.SelectedValue, where, "NombreCategoria ");
            }
        ...
        {
            SqlCategoria.SelectCommand = ObtenerSql();
